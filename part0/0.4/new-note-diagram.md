```mermaid
  sequenceDiagram
      ...
      Note right of browser: The browser sends a post request to the server, which creates a new note,<br> then sends back a redirect instruction to the browser that executes a GET request.
